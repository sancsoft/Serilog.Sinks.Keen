...
namespace Serilog.Sinks.Keen
{
    ...
    /// that render well in Keen.
    /// </summary>
    static class KeenPropertyFormatter
    {
        static readonly HashSet<Type> KeenScalars = new HashSet<Type>
        {
            typeof(bool),
        ...
        static object SimplifyScalar(object value)
        {
            ...
            if (KeenScalars.Contains(valueType)) return value;
